...
void clear_console_hard_ansi()
{
    ...
    // \033[3J: Clear the scrollback buffer (xterm-like terminals)
    // \033[1;1H: Move cursor to home position (row 1, col 1)
    //printf("\033[2J\033[3J\033[1;1H");

    // Always call fflush(stdout) to ensure the codes are executed immediately
    fflush(stdout);
}
